...
const COS_EMPLOYERS = [
  { company: "Dutch Bros Coffee",    url: 'https://jobs.dutchbros.com/jobs?location=Colorado+Springs%2C+CO&radius=25' },
  { company: "King Soopers",         url: 'https://jobs.kingsoopers.com/jobs?q=&l=Colorado+Springs%2C+CO&radius=25' },
